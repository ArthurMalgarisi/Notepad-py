...
class Notepad:
    ...
    def __init__(self, **kwargs):
        ...
        screenWith = self.__root.winfo_screenmmwidth()
        screenHeight = self.__root.winfo_screenheight()

        left = (screenWith / 2) - (self.__thisWidth / 2)
        ...
        self.__thisEditMenu.add_command(label = "Sair", command = self.__quitApplication)
        self.__thisEditMenu.add_cascade(label = "File", menu = self.__thisFileMenu)
        ...
        self.__thisHelpMenu.add_command(label = "Sobre Notepad", command = self.__showAbout)
